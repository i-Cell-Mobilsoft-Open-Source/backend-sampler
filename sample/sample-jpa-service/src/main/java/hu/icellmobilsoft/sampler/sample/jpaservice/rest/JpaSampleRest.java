...
public class JpaSampleRest extends BaseRestService implements ISampleRest {
    ...
    @Inject
    private JpaSampleGetAction jpaSampleAction;

    @Inject
    private JpaSamplePostAction jpaSampleQueryAction;

    @Override
    public SampleResponse getSample() throws BaseException {
        return wrapNoParam(jpaSampleAction::sample, "getSample");
    }

    @Override
    public SampleResponse postSample(SampleRequest sampleRequest) throws BaseException {
        return wrapPathParam1(jpaSampleQueryAction::sampleQuery, sampleRequest, "postSample", "sampleRequest");
    }
}
