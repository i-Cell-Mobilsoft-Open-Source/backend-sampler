 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.restservice.rest.filter.utils;
...
import hu.icellmobilsoft.sampler.sample.restservice.rest.utils.marshalling.MarshallingUtil;
...
public class RequestResponseLogger {
     ...
     * @return response
     */
    public String printResponseEntity(String fullPath, WriterInterceptorContext context, byte[] entityCopy) {
        StringBuffer sb = new StringBuffer();
        if (context == null) {
            return sb.toString();
        }
