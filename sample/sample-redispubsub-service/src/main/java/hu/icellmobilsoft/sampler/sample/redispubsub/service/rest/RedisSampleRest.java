 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.redispubsub.service.rest;
...
import hu.icellmobilsoft.sampler.sample.redispubsub.service.action.RedisPubSubSampleGetAction;
import hu.icellmobilsoft.sampler.sample.redispubsub.service.action.RedisPubSubSamplePostAction;
...
public class RedisSampleRest extends BaseRestService implements ISampleRest {
    ...
    @Inject
    private RedisPubSubSampleGetAction redisSampleGetAction;

    @Inject
    private RedisPubSubSamplePostAction redisSamplePostAction;
