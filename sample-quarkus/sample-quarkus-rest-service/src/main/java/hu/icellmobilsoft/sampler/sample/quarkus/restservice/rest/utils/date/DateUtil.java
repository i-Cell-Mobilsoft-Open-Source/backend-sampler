 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.date;
...
public class DateUtil {
    private static Logger LOGGER = org.jboss.logging.Logger.getLogger(DateUtil.class);
