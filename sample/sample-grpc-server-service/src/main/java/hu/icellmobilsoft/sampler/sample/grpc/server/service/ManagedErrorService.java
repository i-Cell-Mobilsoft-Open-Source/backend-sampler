...
import hu.icellmobilsoft.sampler.sample.grpc.server.service.error.ErrorServiceImpl;
 ...
 */
@ApplicationScoped
public class ManagedErrorService implements BindableService, IGrpcService {

    private ErrorServiceImpl service;

    public ManagedErrorService() {
    }

    @Inject
    public ManagedErrorService(SampleGrpcAction sampleCdiAction) {
        ...
        this.service = new ErrorServiceImpl(sampleCdiAction);
    }
