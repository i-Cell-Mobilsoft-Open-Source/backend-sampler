...
import hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.date.DateXmlUtil;
...
public class XMLGregorianCalendarConverter implements JsonSerializer<XMLGregorianCalendar>, JsonDeserializer<XMLGregorianCalendar> {
    ...
    private static Logger LOGGER = org.jboss.logging.Logger.getLogger(XMLGregorianCalendarConverter.class);
