 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.error;
...
public class XsdValidationErrorCollector implements IXsdValidationErrorCollector {
    private static Logger log = Logger.getLogger(XsdValidationErrorCollector.class);
