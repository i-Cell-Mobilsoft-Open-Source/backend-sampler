...
/**
 * REST API for quarkus sample
 * 
 * @author czenczl
 * @since 0.1.0
 */
@Tag(name = ISampleRestClient.TAG_SAMPLE, description = "Minta folyamattal kapcsolatos REST operációk")
...
public interface ISampleRestClient {
    ...
    @Operation(summary = "Sample GET", //
            description = "* Sample.\n" //
                    + "* Minta")
    @Tag(ref = ISampleRestClient.TAG_SAMPLE)
    @GET
