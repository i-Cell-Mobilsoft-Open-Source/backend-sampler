 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.gson;
...
import hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.date.DateParseHelper;
import hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.date.DatePrintUtil;
...
public class OffsetDateTimeConverter implements JsonSerializer<OffsetDateTime>, JsonDeserializer<OffsetDateTime> {
    ...
    private static Logger LOGGER = org.jboss.logging.Logger.getLogger(OffsetDateTimeConverter.class);
