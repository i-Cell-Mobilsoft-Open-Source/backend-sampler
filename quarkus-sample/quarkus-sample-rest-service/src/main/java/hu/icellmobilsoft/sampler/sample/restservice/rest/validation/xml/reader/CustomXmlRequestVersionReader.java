 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.reader;
 ...
 */
@Model
public class CustomXmlRequestVersionReader implements IXmlRequestVersionReader {
        ...
        try {
            ...
            if (reader != null) {
                try {
                    ...
                    Logger.getLogger(CustomXmlRequestVersionReader.class).warn(e.getLocalizedMessage());
                    ;
                }
            }
        }
