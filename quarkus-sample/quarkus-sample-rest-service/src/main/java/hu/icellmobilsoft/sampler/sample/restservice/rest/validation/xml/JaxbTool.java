 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml;
...
import hu.icellmobilsoft.sampler.sample.restservice.rest.tool.utils.annotation.RangeUtil;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.annotation.ValidateXML;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.error.XsdValidationErrorCollector;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.exception.XsdProcessingException;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.reader.CustomXmlRequestVersionReader;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.utils.CustomXsdResourceResolver;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.utils.IXsdResourceResolver;
import hu.icellmobilsoft.sampler.sample.restservice.rest.validation.xml.utils.XsdHelper;
...
public class JaxbTool {
    ...
    @Inject
    private CustomXmlRequestVersionReader xmlRequestVersionReader;

    @Inject
    private CustomXsdResourceResolver resourceResolver;

    @Inject
    private XsdHelper xsdHelper;

    @Inject
    private XsdValidationErrorCollector errorCollector;
    ...
    public String getRequestVersion(InputStream entityStream) throws XsdProcessingException {
        ...
        try {
            entityStream.mark(0);
            String requestVersion = xmlRequestVersionReader.readFromXML(entityStream);
            entityStream.reset();
