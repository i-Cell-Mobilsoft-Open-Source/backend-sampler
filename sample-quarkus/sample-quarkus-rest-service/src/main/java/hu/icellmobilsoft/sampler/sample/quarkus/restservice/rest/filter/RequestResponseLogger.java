 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.filter;
...
import hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.StringHelper;
import hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.gson.JsonUtil;
import hu.icellmobilsoft.sampler.sample.quarkus.restservice.rest.utils.marshalling.MarshallingUtil;
...
public class RequestResponseLogger {
     ...
     */
    public String printRequestHeaders(Map<String, List<String>> headerValues) {
    ...
    public String printRequestEntity(ContainerRequestContext requestContext) {
        ...
        try {
            ...
            //
            requestContext.setEntityStream(new ByteArrayInputStream(requestEntity));
            return printRequestEntity(requestEntity, RequestResponseLogger.BYTECODE_MAX_LOG);
        } catch (IOException e) {
     ...
     */
    public String printResponseLine(String fullPath, int httpStatus, String statusInfo, String mediaType) {
        StringBuffer sb = new StringBuffer();
    ...
    public String printResponseEntity(String fullPath, WriterInterceptorContext writerInterceptorContext, byte[] entityCopy) {
        ...
        if (skipLoggingForPathOrMediaType(fullPath, mediaType)) {
            ...
            // mediaType));
            sb.append(printResponseEntity(responseText, -1, mediaType));
        }
        return sb.toString();
    }
}
