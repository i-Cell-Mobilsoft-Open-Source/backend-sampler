...
import hu.icellmobilsoft.sampler.dto.sample.batch.jpaconverterentity.JpaConverterEntityUpdateType;
import hu.icellmobilsoft.sampler.model.sample.batch.JpaConverterEntity;
import hu.icellmobilsoft.sampler.sample.jpa.batch.service.service.JpaConverterEntityService;
...
public class JpaConverterEntityAction extends BaseAction {
    ...
    @Inject
    private JpaConverterEntityService jpaConverterEntityService;
