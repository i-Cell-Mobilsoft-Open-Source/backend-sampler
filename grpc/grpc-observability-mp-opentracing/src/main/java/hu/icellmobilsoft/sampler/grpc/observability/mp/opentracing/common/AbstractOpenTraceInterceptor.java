 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.grpc.observability.mp.opentracing.common;
...
public abstract class AbstractOpenTraceInterceptor {
    ...
    private static final String TAG_COMPONENT = "gRPC";
    ...
    protected SpanBuilder createSpanBuilder(MethodDescriptor<?, ?> methodDescriptor, Tracer tracer) {
        ...
        spanBuilder.withTag(Tags.COMPONENT.getKey(), TAG_COMPONENT);
