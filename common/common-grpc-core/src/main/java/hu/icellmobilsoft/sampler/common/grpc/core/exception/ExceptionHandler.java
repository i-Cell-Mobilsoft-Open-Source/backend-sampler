 ...
 * #L%
 */
package hu.icellmobilsoft.sampler.common.grpc.core.exception;
 ...
 *
 * <p>
 * ExceptionMappers with higher priority value (specified via {@link jakarta.annotation.Priority}) are selected first. If no matching ExceptionMapper
 * is found, an {@link com.google.rpc.Code#INTERNAL} error {@link com.google.rpc.Status} is returned.
 * </p>
 *
